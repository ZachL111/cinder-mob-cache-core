"""Regression checks for the cinder-mob-cache-core casebook."""
...
from casebook.harness import assert_expected, cinder_mob_cache_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_mob_cache_core_summary(), assert_expected())
